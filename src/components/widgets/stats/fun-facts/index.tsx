...
const brags: Array<ReactNode> = [
  ...
  <p key="2">
    ...
    Trans-Siberian train for a full week reading Kirkegaard books.
  </p>,
  <p key="3">
    I was pretty drunk on the profile photo{" "}
    <span className="hidden md:inline">on the top left</span>.
  </p>,
  <p key="4">
  ...
  <p key="5">
    I lived in 8 countries, and visited more than 40. There are more than 25
  ...
  <p key="8">
    I{"'"}ve played more than 14.000 online chess games since January of 2020.
