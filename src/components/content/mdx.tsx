...
const components = {
  ...
  h2: ({ className, ...props }: HTMLAttributes<HTMLHeadElement>) => (
    <h2
      className={cn(
  ...
  h3: ({ className, ...props }: HTMLAttributes<HTMLHeadElement>) => (
    <h3
      className={cn(
  ...
  h4: ({ className, ...props }: HTMLAttributes<HTMLHeadElement>) => (
    <h4
      className={cn(
  ...
  h5: ({ className, ...props }: HTMLAttributes<HTMLHeadElement>) => (
    <h5
      className={cn(
  ...
  h6: ({ className, ...props }: HTMLAttributes<HTMLHeadElement>) => (
    <h6
      className={cn(
