...
. I got really excited, and during a hackaton I prototyped a code generator which would combine the given open source tools (like [openapi-typescript-codegen](https://github.com/ferdikoomen/openapi-typescript-codegen)) and all the business logic we had and produce a type-safe client package into our frontend monorepo. This got slowly adopted afterwards, but there were still a lot of problems. Some services didn't have auto-generated OpenAPI specs, the information in them was outdated, so sometimes types vs. reality didn't quite match the expectations.
</div>

Shortly after I went through this enlightenment, [Orval](https://orval.dev/) came out and simplified things even more. It gave you a fully typed client library with a variety of outputs you could choose from, my favorite at the time obviously being [React Query](https://react-query.tanstack.com/). I felt like REST APIs were finally just as pleasant to use on the frontend as GraphQL was with its schemas and client generators.
